    ...
    return (
        <div className="min-h-screen -m-4 sm:-m-6 lg:-m-8 animate-pulse">
            ...
            <div className="relative">
                {/* Backdrop gradient placeholder */}
                <div className="absolute inset-x-0 top-0 h-80 sm:h-[420px] bg-gradient-to-br from-base-300 via-base-200 to-base-300 pointer-events-none" style={{ zIndex: 0 }} />
                ...
                <div className="relative px-4 sm:px-8 lg:px-12 pt-8 sm:pt-10 pb-8" style={{ zIndex: 1 }}>
                    <div className="flex flex-col sm:flex-row gap-6 sm:gap-8 max-w-5xl">
                        ...
                        <div className="shrink-0 mx-auto sm:mx-0 w-36 sm:w-44 md:w-52">
                            <div className="aspect-[2/3] rounded-2xl bg-base-300 ring-2 ring-white/5 shadow-2xl" />
                        ...
                        <div className="flex-1 min-w-0 pt-2">
                            ...
                            {/* Title */}
                            <div className="h-9 w-3/4 rounded-xl bg-base-300 mb-1" />

                            {/* Original title */}
                            <div className="h-3 w-1/3 rounded bg-base-300/60 mb-2" />

                            {/* Tagline */}
                            <div className="h-4 w-1/2 rounded bg-base-300/70 mb-3" />

                            {/* Meta row — date · runtime · language · seasons */}
                            ...
                            <div className="flex flex-wrap items-center gap-2 mb-3">
                                <div className="h-7 w-16 rounded bg-base-300" />
                                <div className="h-7 w-16 rounded bg-base-300" />
                                <div className="h-7 w-16 rounded bg-base-300" />
                            </div>
                            ...
                            {/* Action buttons — Play · Trailer · Watchlist · Favourite */}
            ...
            <div className="space-y-8 px-4 sm:px-8 lg:px-12 pb-20">
                ...
                <div className="max-w-5xl">
                    <div className="flex items-center gap-2 mb-3">
                        <div className="h-[18px] w-[18px] rounded bg-base-300" />
                        <div className="h-5 w-28 rounded bg-base-300" />
                    </div>
                    <div className="space-y-3">
                        {[1, 2].map((i) => (
                            <div key={i} className="bg-base-200 rounded-xl overflow-hidden border border-white/5">
                                <div className="flex items-center gap-3 p-4">
                                    ...
                                    <div className="w-4 h-4 rounded bg-base-300 shrink-0" />
                                </div>
                            </div>
                        ))}
                    </div>
                    ...
                    <div className="flex gap-4 overflow-hidden">
                        {[1, 2, 3, 4, 5, 6, 7].map((i) => (
                            <div key={i} className="w-20 sm:w-24 shrink-0 text-center">
                                ...
                                <div className="h-2.5 w-10 rounded bg-base-300/70 mx-auto" />
                            </div>
                        ))}
                    </div>
                </div>
                ...
                <div>
                    ...
                    <div className="flex gap-3 overflow-hidden">
                        {[1, 2, 3].map((i) => (
                            <div key={i} className="shrink-0 w-52 sm:w-60 rounded-xl overflow-hidden bg-base-200 border border-white/5">
                                <div className="aspect-video bg-base-300" />
                                <div className="px-3 py-2 space-y-1.5">
                                    <div className="h-3 w-3/4 rounded bg-base-300" />
                                    <div className="h-3 w-1/2 rounded bg-base-300/60" />
                                </div>
                            </div>
                        ))}
                    </div>
                ...
                <div className="max-w-5xl">
                    ...
                    <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-3">
                        {[1, 2, 3, 4, 5, 6, 7, 8].map((i) => (
                            <div key={i} className="bg-base-200 rounded-xl p-3 flex flex-col gap-1">
                                {/* icon + label */}
                                <div className="flex items-center gap-1.5">
                                    <div className="h-[11px] w-[11px] rounded bg-base-300" />
                                    <div className="h-3 w-12 rounded bg-base-300/70" />
                                </div>
                                {/* value */}
                                <div className="h-4 w-20 rounded bg-base-300" />
                                {/* optional note (Dual Audio etc.) */}
                                {i === 2 && <div className="h-2.5 w-14 rounded bg-primary/20 mt-0.5" />}
                            </div>
                        ))}
                    </div>
                </div>
                    ...
                    <div className="flex gap-3 overflow-hidden">
                        {[1, 2, 3, 4, 5, 6].map((i) => (
                            <div key={i} className="shrink-0 w-40 sm:w-44">
                                ...
                                <div className="h-3 w-1/2 rounded bg-base-300/70" />
                            </div>
                        ))}
                    </div>
                </div>
