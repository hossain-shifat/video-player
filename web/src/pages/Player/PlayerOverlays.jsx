        ...
        >
            <div
                style={{
                    ...
                    gap: 10, padding: "16px 14px", borderRadius: 20,
            ...
            >
                ...
                <span style={{ color: "#fff", fontSize: 11, fontWeight: 700, fontFamily: "ui-monospace,'SF Mono',monospace" }}>
                    {label}
                </span>
            </div>
        </div>
    ...
    return (
        ...
        >
            <div style={{ display: "flex", flexDirection: "column", alignItems: "center", gap: 14 }}>
                ...
                <span style={{ color: "rgba(255,255,255,0.6)", fontSize: 13, fontWeight: 500, letterSpacing: "0.02em" }}>
                    Buffering…
                </span>
            </div>
        </div>
...
export function ErrorOverlay({ error, onRetry }) {
    ...
    return (
        <div className="flux-error-overlay">
            ...
            <p style={{ color: "rgba(255,255,255,0.85)", fontSize: 15, fontWeight: 600, maxWidth: 300, textAlign: "center", lineHeight: 1.5 }}>
                {error}
            </p>
            {onRetry && (
                <button
    ...
    return (
        <>
            ...
            <BarPill
                ...
                side="left"
                iconNode={<Moon size={22} color="#fff" strokeWidth={1.8} />}
                pct={brightnessNorm}
