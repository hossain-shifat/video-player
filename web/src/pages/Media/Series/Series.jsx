...
export default function Series() {
    ...
    const filtered = useMemo(() => {
        if (activeGenre === "All") return series;
                    ...
                    {genres.map((g) => (
                        <button
                            ...
                            className={[
                                ...
                                activeGenre === g ? "bg-accent text-accent-content border-accent" : "bg-base-300/40 text-base-content/60 border-base-300 hover:bg-base-300 hover:text-base-content",
                            ].join(" ")}>
                            {g}
                        </button>
                    ))}
